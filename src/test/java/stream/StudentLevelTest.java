...
public class StudentLevelTest {
    ...
    public void whenSorted() {
        ...
        assertThat(StudentScore.levelOf(input, 20), is(expected));
    }
    ...
    public void whenOnlyNull() {
        ...
        input.add(null);
        List<Student> expected = List.of();
        assertThat(StudentScore.levelOf(input, 100), is(expected));
    }
    ...
    public void whenHasNull() {
        ...
        assertThat(StudentScore.levelOf(input, 10), is(expected));
    }
}