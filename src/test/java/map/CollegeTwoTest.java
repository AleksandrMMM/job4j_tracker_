...
class CollegeTwoTest {
    ...
    public void whenAccountIsOptionalEmpty() {
        ...
        CollegeTwo college = new College(students);
        assertThat(college.findByAccount("000010"), is(Optional.empty()));
    }

    @Test
    public void whenAccountIsOptionalNotEmpty() {
        Map<StudentTwo, Set<SubjectTwo>> students = Map.of(
                new StudentTwo("Student1", "000001", "201-18-15"),
                Set.of(
                        new SubjectTwo("Math", 70),
                        new SubjectTwo("English", 85)
                ),
                new StudentTwo("Student2", "000002", "201-18-15"),
                Set.of(
                        new SubjectTwo("Economic", 75),
                        new SubjectTwo("Sociology", 65)
                )
        );
        CollegeTwo college = new CollegeTwo(students);
